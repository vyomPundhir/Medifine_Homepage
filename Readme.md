...
- In this project, I have built a **Medifine HomePage** from the scratch using core `HTML` & `CSS`
...
> I took around **4 hours** to complete this project. The only thing that has taken much time to be implemented is how to adjust the **doctor image, yellow and green blob using z-index and absolute postion property in CSS.**
---
...
> [![Live Link](https://img.shields.io/badge/DEPLOYED-LINK-green)](https://medifine-homepage.vercel.app/)
